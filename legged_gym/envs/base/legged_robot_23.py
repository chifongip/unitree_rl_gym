...
class LeggedRobot(BaseTask):
    ...
    def _push_robots(self):
        ...
        push_env_ids = env_ids[self.episode_length_buf[env_ids] % int(
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[12:12+self.num_actions] = noise_scales.dof_pos * \
            noise_level * self.obs_scales.dof_pos
        noise_vec[12+self.num_actions:12+2*self.num_actions] = noise_scales.dof_vel * \
            noise_level * self.obs_scales.dof_vel
        noise_vec[12+2*self.num_actions:12+3 *
                  self.num_actions] = 0.  # previous actions
